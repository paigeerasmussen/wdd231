const attractions = [
    {
        name: "Old Lahaina Lūʻau",
        address: "1251 Front St, Lahaina, HI 96761",
        price: "$$$$",
        image: "luau.webp",
        description: "Experience traditional Hawaiian culture through an oceanfront sunset lūʻau featuring authentic cuisine and live hula performances. Guests enjoy a multi-course island feast while learning about Polynesian history and storytelling.",
        category: "food"
    },
    {
        ...
        price: "$$$$",
        image: "mamas.webp",
        description: "This iconic beachfront restaurant is known for serving freshly caught local fish prepared with tropical flavors. With its Polynesian-style décor and ocean views, it offers one of Maui’s most memorable dining experiences.",
        category: "food"
    },
    {
        name: "Tin Roof Maui",
        ...
        price: "$$",
        image: "tinroof.webp",
        description: "A popular local spot in Kahului serving creative Hawaiian comfort food in a casual setting. Signature dishes like mochiko chicken and garlic noodles make it a must-visit for quick and flavorful island fare.",
        category: "food"
    },
    {
        ...
        price: "$$",
        image: "leodas.webp",
        description: "This charming roadside eatery offers farm-to-table sandwiches, savory dishes, and freshly baked pies. It’s the perfect stop while exploring West Maui or driving along the scenic coastline.",
        category: "food"
    },
    {
        name: "Kihei Caffe",
        ...
        price: "$",
        image: "kihei.webp",
        description: "A laid-back breakfast and brunch café known for generous portions and local favorites. It’s a great affordable option for starting your day before heading to the beach or exploring the island.",
        category: "food"
    },
    {
        name: "Haleakalā National Park",
        address: "Haleakalā Hwy, Kula, HI 96790",
        price: "$30 per vehicle",
        image: "nationalpark.webp",
        description: "Watch a breathtaking sunrise or sunset from the summit of Haleakalā volcano. The park also offers unique hiking trails through a dramatic crater landscape found nowhere else on earth.",
        category: "outdoor"
    },
    {
